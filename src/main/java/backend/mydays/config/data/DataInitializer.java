...
public class DataInitializer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// 3. Create Posts
		Post post1 = createPostIfNotFound(user1, challenge1, "물 2리터 마시기 성공! 상쾌하네요.",
			"https://picsum.photos/id/10/400/300");
		Post post2 = createPostIfNotFound(user2, challenge1, "물 마시기 챌린지 완료! 덕분에 피부가 좋아진 것 같아요.",
			"https://picsum.photos/id/20/400/300");
		Post post3 = createPostIfNotFound(user1, challenge2, "10분 명상으로 마음의 평화를 찾았습니다.",
			"https://picsum.photos/id/30/400/300");
		Post post4 = createPostIfNotFound(user3, challenge2, "명상 챌린지 성공! 꾸준히 해봐야겠어요.",
			"https://picsum.photos/id/40/400/300");
		Post post5 = createPostIfNotFound(user2, challenge3, "감사일기 작성 완료! 소소한 행복을 찾았어요.",
			"https://picsum.photos/id/50/400/300");
		Post post6 = createPostIfNotFound(user1, challenge4, "계단 이용 챌린지! 다리가 튼튼해지는 기분입니다.",
			"https://picsum.photos/id/60/400/300");
		Post post7 = createPostIfNotFound(user3, challenge5, "아침 스트레칭으로 개운하게 하루 시작!",
