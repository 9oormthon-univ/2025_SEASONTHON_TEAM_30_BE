...
public class ChallengeController {
    ...
    @GetMapping("/today")
    public ResponseEntity<BaseResponse<TodayChallengeResponseDto>> getTodayChallenge(@AuthenticationPrincipal UserDetails userDetails) {
        TodayChallengeResponseDto response = challengeService.getTodayChallenge(userDetails.getUsername());
